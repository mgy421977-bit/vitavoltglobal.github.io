...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (navMenu) {
            ...
            <div class="vv-nav-dropdown" data-menu="solutions">
                ...
                <div class="vv-mega-menu" role="menu">
                    <div class="vv-mega-lead">
                        ...
                        <a class="vv-mega-category vv-secondary" href="/services.html"><span class="vv-mega-category-icon">◆</span><span><strong>Diğer Çözümler</strong><small>EPC, karbon, su ve enerji zekâsı.</small></span><span class="vv-arrow">›</span></a>
                    </div>
        ...
        style.textContent = `
            ...
            .vv-mega-category{display:grid;grid-template-columns:38px 1fr 18px;gap:10px;align-items:center;padding:14px 10px;border-radius:10px;color:var(--color-text);transition:background .2s ease,color .2s ease}.vv-mega-category:hover,.vv-mega-category:focus-visible{background:rgba(0,174,239,.10);color:var(--color-text)}.vv-mega-category.vv-secondary{margin-top:10px;border-top:1px solid rgba(255,255,255,.08);border-radius:0;padding-top:18px}.vv-mega-category-icon{font-size:22px;color:var(--color-success)}.vv-mega-category strong{display:block;font-size:13px;line-height:1.35}.vv-mega-category small{display:block;color:var(--color-text-muted);font-size:11px;line-height:1.4;margin-top:4px}.vv-arrow{font-size:22px;color:var(--color-primary)}
