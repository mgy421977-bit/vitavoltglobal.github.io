...
const translations = {
  tr: {
    ...
    "hero-chip-loc": "İzmir · Ege",
    "hero-chip-services": "GES · EPC · BESS · Karbon",
    "hero-subtitle": "Endüstriyel enerji dönüşümü için uçtan uca mühendislik çözümleri.",
    "hero-desc": "Vitavolt Global, İzmir'de faaliyet gösteren yenilenebilir enerji firmasıdır. Güneş enerjisi santralleri (GES), endüstriyel EPC, batarya enerji depolama sistemleri (BESS), su yönetimi ve karbon danışmanlığı hizmetleri sunuyoruz.",
    ...
    "about-who": "BİZ KİMİZ?",
    "about-p1": "Vitavolt Global, İzmir (Bayraklı) ofisiyle yenilenebilir enerji ve sürdürülebilir mühendislik firmasıdır.",
    ...
    "contact-hero-sub": "İzmir (Bayraklı) · Teklif ve bilgi hattı",
    "contact-reach": "BİZE ULAŞIN",
    "contact-reach-sub": "İzmir ofisimiz ve tüm iletişim kanallarımız",
  ...
  en: {
    ...
    "hero-desc": "Vitavolt Global operates in Izmir. We provide solar power plants (PV), industrial EPC, battery energy storage systems (BESS), water management and carbon advisory services.",
    ...
    "svc-ges-desc": "High-efficiency solar power plant design and installation in Izmir and surroundings.",
    ...
    "footer-desc": "Vitavolt Global, based in Izmir, provides engineering solutions in renewable energy.",
    ...
    "about-p1": "Vitavolt Global is a renewable energy and sustainable engineering company based in Izmir (Bayrakli).",
    ...
    "contact-hero-sub": "Izmir (Bayrakli) · Quote and information line",
    "contact-reach": "REACH US",
    "contact-reach-sub": "Our Izmir office and all contact channels",
    "contact-phone": "Phone",
    "contact-email": "Email",
