/* Vitavolt Global — VITA Engine Offline Pre-Feasibility Core | build 2026-09-17-v3-water-bom */
(function (window) {
  'use strict';
  var ENGINE_VERSION = '3.0.0', BUILD = '2026-09-17-v3-water-bom', DB_VERSION = '1.9';
  var CONFIG = {
  ...
  function autoInverter(dcKwp, pricing) {
    ...
    for (var i = 0; i < a.length; i++) if (+a[i].power_kw >= dcKwp) return { opt: a[i], reason: 'smallest_catalog_unit_covering_dc_kwp', count: 1 };
